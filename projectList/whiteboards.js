export default {
  ...
  id: "whiteboards",
  date: "2020",
  url: "https://whiteboard-bf561.web.app/",
  ...
  description:
    ...
    The pandemic made us want a convenient place to collaboratively sketch pictures for fun, work through \
    math problems, and more. From this idea, we created an online whiteboard that includes several drawing \
    tools and can be viewed and edited by many people simultaneously. To enable collaboration, we leveraged \
    Google Firebase's Cloud Firestore and connected it to an HTML canvas. Some drawing tools include shape \
