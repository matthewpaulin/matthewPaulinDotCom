export default {
    ...
    "url": "",
    "github": "#",
    "description": "Boardzilla is an online application that serves as a dashboard for a variety of \
    ...
    on the users’ dashboards.  In addition, users will be able to input datainto each widget \
    ...
    "subtitle" : "Boardzilla is an app to create personalized dashboards constructed with a variety of customizable widgets.",
    "slug": "boardzilla",
    "images" : [
        {
    ...
    "categories" : ["MongoDB", "Express", "React", "Redux", "Node", "Bulma"],
}